...
| **2** | [The SQL Language and Our Example Database](https://shikharkumar13.github.io/SQL-End-to-End-Theory-and-Hands-On/2_SQL_Language_and_Database.html) | DDL / DML / DQL / DCL / TCL · data types · NULL · practice environment setup · full schema walkthrough |
| **3** | [DDL - Building the Structure of Our Database](https://shikharkumar13.github.io/SQL-End-to-End-Theory-and-Hands-On/3_DDL_Building_Structure.html) | `CREATE DATABASE` · `CREATE TABLE` · constraints (PK, FK, NOT NULL, UNIQUE, DEFAULT, CHECK, AUTO_INCREMENT) · `ALTER TABLE` · `DROP` · `TRUNCATE` |
| **4** | [DML - Bringing the Database to Life](https://shikharkumar13.github.io/SQL-End-to-End-Theory-and-Hands-On/4_DML_Bringing_Data_to_Life.html) | `INSERT` (single & multi-row) · `UPDATE` · `DELETE` · referential integrity · transactions (`COMMIT` / `ROLLBACK`) |
| **5** | [DQL I - SELECT, Filtering & Sorting](https://shikharkumar13.github.io/SQL-End-to-End-Theory-and-Hands-On/5_DQL_Commands_1.html) | `SELECT` · column aliases · `DISTINCT` · `WHERE` with `=`, `!=`, `>`, `<`, `AND`, `OR`, `NOT`, `BETWEEN`, `IN`, `LIKE`, `IS NULL` · `ORDER BY` · `LIMIT` / `OFFSET` |
| **6** | [DQL II - Aggregation & Grouping](https://shikharkumar13.github.io/SQL-End-to-End-Theory-and-Hands-On/6_DQL_Aggregation_Grouping.html) | `COUNT` · `SUM` · `AVG` · `MIN` · `MAX` · `ROUND` · `GROUP BY` · `HAVING` · `DATE_FORMAT` · `MONTH` / `YEAR` · WHERE vs HAVING · execution order |
| **7** | [DQL III - Joining Tables](https://shikharkumar13.github.io/SQL-End-to-End-Theory-and-Hands-On/7_DQL_Joins.html) | Table aliases · `INNER JOIN` · `LEFT JOIN` · `RIGHT JOIN` · multi-table joins · self-join · cross join · FULL OUTER JOIN workaround · `UNION` / `UNION ALL` · ON vs WHERE with LEFT JOIN |
| **8** | [DQL IV - Subqueries, CTEs & CASE](https://shikharkumar13.github.io/SQL-End-to-End-Theory-and-Hands-On/8_DQL_Subqueries_CTEs_CASE.html) | Scalar subqueries · multi-row subqueries (`IN` / `NOT IN`) · correlated subqueries · `EXISTS` · derived tables · `WITH` (CTE) · multiple CTEs · `CASE` (simple & searched) · `COALESCE` · conditional aggregation |
| **9** | [DQL V - Window Functions & Capstone](https://shikharkumar13.github.io/SQL-End-to-End-Theory-and-Hands-On/9_DQL_Window_Functions_Capstone.html) | `ROW_NUMBER` · `RANK` · `DENSE_RANK` · `LAG` / `LEAD` · `SUM OVER` running totals · `MAX OVER` · percentage share · frame clause · `CREATE VIEW` · best practices · 8-question capstone |
